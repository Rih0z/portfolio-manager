 ...
 * ファイルパス: functions/alpaca-api-proxy.js 
 * 
 * 作成者: Koki Riho （https://github.com/Rih0z） 
 * 作成日: 2023/03/15 14:30:00 
 * 
 * 更新履歴: 
 * - 2023/03/15 14:30:00 Koki Riho 初回作成
 * - 2023/04/20 09:45:00 Yuta Sato ETF対応機能を追加
 * - 2023/05/07 11:20:00 Koki Riho ETF特性検出機能を強化、多重エンドポイント試行機能を追加
 * 
 * 説明: 
 * Alpaca APIへのプロキシとして機能し、株価データを取得するサーバーレス関数。
 * 特にETF（上場投資信託）の識別と特殊処理に対応している。
 * ETFのタイプを自動判別し、配当情報などの特性情報を追加して返す。
 * 複数のエンドポイントを順次試行することで、高信頼性のデータ取得を実現している。
 */
