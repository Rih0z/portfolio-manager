...
**作成日**: 2026-03-03
**最終更新**: 2026-03-04（Phase 1 Week 1-2 JWT認証移行完了 + セキュリティレビュー全修正反映）
...
- 完全無料、収益化コードゼロ
- React SPA (Vite 7.x) + AWS Lambda + DynamoDB
...
| **アーキテクチャ** | PortfolioContext.js 76KB。Vite移行済。TypeScriptなし | 🟡 |
...
セッションベース認証           →  JWT + Refresh Token + Session デュアルモード ← 完了（Phase 1 W1-2）
