...
jest.mock('../../../../src/utils/jwtUtils', () => ({
  generateAccessToken: jest.fn().mockResolvedValue('mock-jwt-access-token'),
  generateRefreshToken: jest.fn().mockResolvedValue('mock-jwt-refresh-token')
}));
...
describe('Google Login Handler', () => {
  ...
  beforeEach(() => {
    ...
    cookieParser.createRefreshTokenCookie = jest.fn().mockReturnValue(
      'refreshToken=mock-jwt-refresh-token; Max-Age=604800; HttpOnly; Secure; SameSite=None'
    );
