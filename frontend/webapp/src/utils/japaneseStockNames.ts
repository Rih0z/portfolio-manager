...
export const MUTUAL_FUND_NAMES: Record<string, string> = {
  ...
  '03311183': 'eMAXIS Slim 新興国株式インデックス',
  '0331318A': 'eMAXIS Slim バランス(8資産均等型)',
  '03311219': 'eMAXIS Slim 先進国債券インデックス',
  '0331121B': 'eMAXIS Slim 国内債券インデックス',

  // 大和
  '04311138': 'iFree 日経225インデックス',
  '04311217': 'iFree TOPIXインデックス',
  '04311224': 'iFree 外国株式インデックス(為替ヘッジなし)',
  '04312165': 'iFree S&P500インデックス',
  '04312177': 'iFree レバレッジ NASDAQ100',

  // 野村
  '01311021': '野村インデックスファンド・日経225',
  '01311101': '野村インデックスファンド・TOPIX',
  '01312203': '野村インデックスファンド・外国株式',
  ...
  '89312259': 'SBI・V・米国高配当株式インデックス・ファンド',
  ...
  // セゾン
  '64311096': 'セゾン・バンガード・グローバルバランスファンド',
  '64311126': 'セゾン資産形成の達人ファンド',

  // 農林中金
  '3A311234': '農林中金<パートナーズ>長期厳選投資 おおぶね',

  // りそな
  '58311052': 'りそな日経225オープン',

  // 日興
  '79312179': 'インデックスファンド225',
  '79312183': 'インデックスファンドTSP',
};

// 主要な日本株の名前マッピング
export const JAPAN_STOCK_NAMES: Record<string, string> = {
  // トヨタグループ
  '7203': 'トヨタ自動車',
  '6201': '豊田自動織機',
  '6902': 'デンソー',
 ...
 */
export const getJapaneseStockName = (ticker: string): string => {
 ...
 */
export const formatJapaneseStockDisplay = (ticker: string): string => {
