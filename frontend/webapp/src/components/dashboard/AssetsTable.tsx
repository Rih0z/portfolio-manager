...
const AssetsTable = () => {
  ...
  if (sortedData.length === 0) {
    return (
      <div className="bg-card rounded-lg shadow border border-border p-6 text-center">
        <h2 className="text-xl font-semibold mb-2 text-foreground">保有資産詳細</h2>
        <p className="text-muted-foreground">保有資産が設定されていません。</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-card rounded-lg shadow border border-border overflow-hidden">
      <h2 className="text-xl font-semibold p-6 pb-4 text-foreground">保有資産詳細</h2>
