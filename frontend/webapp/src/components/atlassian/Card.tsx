...
const Card = forwardRef((props: any, ref: any) => {
  const {
    children,
    elevation = 'medium',
    padding = 'medium',
...
export const CardHeader = ({ children, className = '', style = {} }: any) => (
  <div
    className={className}
    style={{
...
export const CardContent = ({ children, className = '', style = {} }: any) => (
  <div
    className={className}
    style={{
      ...style
...
export const CardFooter = ({ children, className = '', style = {} }: any) => (
  <div
    className={className}
    style={{
...
export const CardActions = ({ children, align = 'right', className = '', style = {} }: any) => {
