...
export const ModalHeader = ({ children, className = '', style = {} }: any) => {
  const isDarkTheme = document.documentElement.classList.contains('dark');
...
export const ModalBody = ({ children, className = '', style = {} }: any) => (
  <div
...
export const ModalFooter = ({ children, align = 'right', className = '', style = {} }: any) => {
