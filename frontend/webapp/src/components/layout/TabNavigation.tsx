...
const TabNavigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-card/95 backdrop-blur-xl border-t border-border z-50" data-testid="tab-navigation" aria-label={t('navigation.mainNav', 'メインナビゲーション')}>
