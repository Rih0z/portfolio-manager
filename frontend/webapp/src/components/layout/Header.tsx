        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <Link to="/dashboard" className="flex items-center space-x-3">
              ...
              <h1 className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-primary-500 to-primary-600 bg-clip-text text-transparent">
                {t('app.name')}
              </h1>
            </Link>
        ...
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center min-w-0 flex-1">
            <Link to="/dashboard" className="flex-shrink-0 flex items-center space-x-3">
              ...
              <h1 className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-primary-500 to-primary-600 bg-clip-text text-transparent truncate">
                {t('app.name')}
              </h1>
            </Link>
          </div>
